...
# ── 모든 역할: 자동 로그인 토큰 갱신 (새로고침 시 세션 유지) ──
...
if role == 'admin':
    ...
    if page == "dashboard":
        ...
        from modules.hq_admin.photo_tab import render_photo_tab
        render_photo_tab(user)
    ...
    if page == "dashboard":
        ...
        from modules.vendor_admin.photo_tab import render_photo_tab
        render_photo_tab(user)
